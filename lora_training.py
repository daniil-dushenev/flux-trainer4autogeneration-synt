...
class FluxLoRATrainer:
    ...
    def _train_with_diffusers(self, dataset: Any) -> Path:
        ...
        На CPU создает mock LoRA для тестирования логики.
        """
        ...
        print(f"Mock LoRA created at {final_path}")
        print("Note: This is a placeholder for testing. Real training requires GPU.")
